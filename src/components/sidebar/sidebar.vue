              ...
              :key="'toggle' + pIndex">            
                <b-row :key="'row' + pIndex">
                  ...
                  <b-col class="delete-button-col">
                    <span @click.stop="deleteProject(item)" title="Delete project">
                    ...
                    @click="selectEnv(env)">
                      <div class="d-flex">
                        ...
                        <div class="env-remove-button ml-auto">
                          <span @click.stop="removeEnv(env)" title="Remove environment">
                            <b-icon icon="x" aria-label="Remove environment"></b-icon>
                          </span>
                        </div>
                      </div>
                  </b-list-group-item> 

                  <b-list-group-item href="#" class="child-item" :key="'addEnv' + pIndex">
                    <div class="d-flex">
